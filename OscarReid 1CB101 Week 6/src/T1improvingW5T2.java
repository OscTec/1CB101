...
public class T1improvingW5T2 {
	// public class Task2N {
	public static void toStart() {
		System.out.println("These are your options");
		System.out.println("1) Print word x times 2) Initails");
		System.out.println("3) Middle names       4) Reverse");
		System.out.println("5) Dashes             6) Password checker");
